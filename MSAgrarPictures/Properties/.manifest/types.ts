...
export interface Homepage {
  ...
  Best Of Text: string;
  Info Text: string;
  Seitenbild: { small: string; large: string; original: string };
  Hintergrundbild: { small: string; large: string; original: string };
}
...
export interface Einstellungen {
  id: string;
  Logo: { small: string; large: string; original: string };
